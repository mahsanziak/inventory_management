...
const BillingManagement = ({ onBackToSettings }) => {
  ...
  useEffect(() => {
    if (selectedBranch) {
      // Fetch settings and invoices for the selected branch
  ...
  return (
    <div className={styles.billingManagement}>
      ...
      <button onClick={onBackToSettings} className={styles.backButton}>Back to Settings</button>
    </div>
  );
};
